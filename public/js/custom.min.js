    ...
    return {
        init: function() {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each((function() {
                ...
                function() {
                ...
                })), jQuery("#lightgallery").length > 0 && $("#lightgallery ,#lightgallery-1 ,#lightgallery-2 ").lightGallery({
                    loop: !0,
                    thumbnail: !0,
                    ...
                    let newTheme = jQuery(this).hasClass("active") ? "dark" : "light";
...
jQuery(document).ready(function() {
    let savedTheme = localStorage.getItem("theme-mode");
    if (savedTheme) {
        jQuery("body").attr("data-theme-version", savedTheme);
        if (savedTheme === "dark") {
